...
1. [直接认证](#direct-authentication)
   - [令牌认证](#token-authentication)
   - [Bearer 令牌认证](#bearer-token-authentication)
   - [基础认证](#basic-authentication)
   - [API 密钥认证](#api-key-authentication)
   - [自定义头认证](#custom-headers-authentication)
2. [基于登录的认证](#login-based-authentication)
   - [JSON 表单登录](#json-form-login)
   - [表单数据登录](#form-data-login)
   - [OAuth2 登录](#oauth2-login)
3. [高级配置](#advanced-configurations)
   - [多重令牌提取](#multiple-token-extraction)
   - [令牌刷新配置](#token-refresh-configuration)
